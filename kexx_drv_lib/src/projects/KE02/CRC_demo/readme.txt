...
configure CRC module works under 16-bit and 32-bit mode.  
It will echo the character entered in the terminal.
...
@par Directory contents
     ==================
- platforms/kexx_config.h   library and board Configuration file
- projects/isr.h            Interrupt handler installation 
- projects/CRC_demo.c       Main program
