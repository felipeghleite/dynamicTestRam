...
configure PMC module and  how to enter all kinds of system mode by PMC API.
...
- projects/ke02/PMC_demo.c  Main program
...
- Configure the serial terminal to protocol: 8-N-1, 9600bps, and flow control: none
- Run the example
- The MCU will enter into stop mode, about 4 seconds later it wakes up.
