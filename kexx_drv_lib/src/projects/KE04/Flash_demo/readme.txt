/**
@page Flash_demo_readme   Flash Demo
@verbatim
...
@par Example description
     ===================
This example provides a template for FLASH sector erase and program.

@par Code configuration
     ===================
Make sure the following macros are defined in ke09_config.h: \n
   USE_FEE and \n
...
- projects/ke04/Flash_demo.c    Main program
