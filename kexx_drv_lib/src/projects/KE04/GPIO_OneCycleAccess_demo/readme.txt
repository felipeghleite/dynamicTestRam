...
via Fast GPIO register, the toggle frequency can be as fast as 20MHz, while
the core clock (not the bus clock) is 40MHz, indicating the Fast GPIO access
in a single cycle.
...
- projects/ke04/GPIO_OneCycleAccess_demo.c  Main program
...
- Measure output frequency on PTB3.
- The frequency should be 20 MHz.
@verbatim
************************END OF FILE********************************************
@endverbatim
