...
configure PWT module and measure input clock on PWTIN[0](PTC4 pin). Simulate 1KHz clock using RTC moudle on PTC5 pin.
calculate input pulse period, print positive pulse width, negative puse width and period(Hz) each 1s.
...
- projects/ke04/PWT_demo.c    Main program
...
- Short pin1(PTC5) and pin2(PTC4), this setup can connect 1KHz output clock on PTC5 to PTC4. Or connect external clock input to PTC4
-Run the example
