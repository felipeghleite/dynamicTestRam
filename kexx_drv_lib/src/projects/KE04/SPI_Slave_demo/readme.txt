/**
@page SPI_Slave_demo_readme   SPI Slave Demo
@verbatim
...
@par Example description
     ===================
This example provides a template for SPI slave transfer with interrupt mode.
it receive the data from SPI master and transfer data to master.\n
PTB2 - SPI0_SCK \n
PTB3 - SPI0_MOSI \n
PTB4 - SPI0_MISO \n
PTB5 - SPI0_SS \n
please move resistor R16 to R17.
it need to connect these signals to the other board programming SPI master code for test.
...
- projects/ke04/SPI_Slave_demo.c    Main program
- projects/ke04/spi_app.c           SPI application drivers
- projects/ke04/spi_app.h           header file of SPI application drivers
