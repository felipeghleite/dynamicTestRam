/**
@page ADC_FIFO_demo_readme   ADC_FIFO_demo
@verbatim
...
@par Example description
     ===================
This example provides a template for ADC trigger a conversion with interrupt mode and FIFO support
...
- projects/ke06/ADC_FIFO_demo.c    Main program
...
- Run the example
- Type any character which will trigger adc conversion and print result in the terminal window
