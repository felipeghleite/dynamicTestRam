/**
@page ADC_Poll_demo_readme   ADC_Poll_demo
@verbatim
...
@par Example description
     ===================
This example provides a template for ADC trigger a conversion and print the results.
...
- projects/ke06/ADC_Poll_demo.c    Main program
