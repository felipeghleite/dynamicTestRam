/**
@page Bitband_demo_readme   Bitband Demo
@verbatim
...
@par Example description
     ===================
This example provides a dmeo to show how to use bit-band to implement bit operation.
...
- projects/ke06/Bitband_demo.c    Main program
