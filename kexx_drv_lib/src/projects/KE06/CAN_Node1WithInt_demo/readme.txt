/**
@page CAN_Node1WithInt_demo_readme   CAN Node1 demo with interrupt mode
@verbatim
...
to Node2 with interrupt mode, and after received a frame,print the frame information.
