/**
@page CAN_Node2_demo_readme   CAN Node2 demo
@verbatim
...
@par Example description
     ===================
This example provides a template MSCAN communication, it receive the message from
the other node, and answer it with itself ID.
...
- projects/ke06/CAN_Node2_demo.c    Main program
