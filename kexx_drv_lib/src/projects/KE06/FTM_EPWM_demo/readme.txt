...
@par Example description
     ===================
This example provides a template for the sample code. It Demonstrates EPWM, output pwm from FTM2 Ch5, LED BLUE on FRDM-KE06 board will blink as pwm pulse width changing..
...
- projects/ke06/FTM_EPWM_demo.c     Main program
...
- Run the example
- Check the FTM2 ch5 waveform, the duty will swing between low and high.
