/**
@page gpio_onecycleaccess_demo_readme   GPIO_OneCycleAccess_demo
@verbatim
...
@par Example description
     ===================
This program It demonstrates how to use FGPIO to operate GPIO pin with one cycle access.
...
- projects/ke06/GPIO_OneCycleAccess_demo.c    Main program
...
- Use a oscilloscope or logic analyzer to measure frequency on PTB2.
